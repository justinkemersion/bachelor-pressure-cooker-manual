# Timing Dictionary: Quick Reference

## High-Contrast Cook Time Table
...
**Always wait 10 minutes** after pressure cooking before quick releasing remaining pressure. This "Starch Set" phase is essential for:
- **Rice:** Prevents mushiness, sets texture
- **Chicken:** Prevents rubbery texture
- **Never skip** - even if you're in a hurry

### The 1:1 + Splash Rule (1.75 Cups)
**For sequential cooking (protein then rice):**
- **Start with 1.75 cups** liquid
- **Rice needs 1.5 cups** (1:1 ratio)
- **0.25 cup buffer** accounts for minimal steam loss
- **Pressure cookers are closed systems** - chicken adds ~1/4 cup juice
...
**Print Scale:** 100% | **Format:** High-Contrast Table
