...
- [ ] **Liquid:** **1.75 cups** Chicken Broth (**Sequential baseline: 1:1.25**)
...
- [ ] **1 tsp Dried Oregano** — *The loud, bold Mediterranean herb. Pairs perfectly with thyme for Italian profiles.*
- [ ] **1 tsp Rosemary** (crushed) — *Mediterranean powerhouse, heat-stable, makes dishes impressive.*
- [ ] **1/2 tsp Fennel Seeds** (crushed slightly) — *Italian licorice flavor, adds complexity and depth.*
...
5.  **Clean Up:** Remove and **discard bay leaves** (if used). Flavor has infused into the liquid.
...
2.  **The Final Drizzle:** Drizzle remaining **1-2 tbsp balsamic** (OR 1-2 tbsp red wine vinegar + pinch of sugar) over everything. 
...
*   **Sequential baseline (1:1.25):** For 1.5 cups rice, use **1.75 cups liquid**. If your liquid has “bits” (frozen peppers/onions, minced peppers, spice sediment), **strain it before the rice phase** to avoid a burn notice.
