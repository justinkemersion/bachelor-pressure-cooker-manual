# 03_Recipes: Chipotle Burrito Bowl - Fond Method (v1.0)
...
## 🛒 Hardware & Variables
- [ ] **Protein:** 1.5 lbs Chicken Thighs (Thawed & Seasoned OR Pre-Marinated Frozen)
...
6.  **Remove chicken** to plate. **Save cooking liquid** - we'll use it for glaze.
...
5.  **Fluff rice** and remove to serving bowl/containers.
6.  **Clean pot completely** - remove all rice grains (important for next step).
