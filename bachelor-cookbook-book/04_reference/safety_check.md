# Safety Check & Chemistry Logic

**Reference Document** - Extracted from the Initiation Recipe for quick lookup.

This document contains the complete safety checks and chemistry explanations that apply to all pressure cooker recipes. Reference this when you need to:
- Check if something is safe to eat
- Understand why a technique works
- Diagnose cooking issues
...
**Source:** Extracted from `03_recipes/chipotle_burrito_bowl.md` (Initiation Recipe)
