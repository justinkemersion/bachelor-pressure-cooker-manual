...
**📚 Building on the Foundation** - Reference the **Initiation Recipe** (`chipotle_burrito_bowl.md`) for fundamentals (liquid ratios, safety checks, troubleshooting). This recipe focuses on what's new: **Creating a sticky glaze from cooking liquid** and **sweet/savory balance** (vs. acid/fat balance from balsamic recipe).

**What You're Learning Here:**
- **Glaze Reduction Technique:** Reducing cooking liquid to create a thick, sticky glaze
- **Sweet/Savory Balance:** Honey + soy sauce = restaurant-quality flavor without complexity
- **Sauce Building:** How to transform cooking liquid into finishing sauce
- **Asian-American Flavor Profile:** Familiar, crowd-pleasing flavors

**Use This Technique In:** Any recipe where you want a sticky, sweet glaze (teriyaki, BBQ-style, honey mustard, etc.)
...
**📦 Pantry Impact:** LOW - Only **honey** is new (versatile ingredient, $5-8, lasts 1+ year). Soy sauce and garlic powder are already in your pantry (Tier 2).
...
## Cook Time
**8 minutes** (HP) + **10 minutes** (NR) + **5 minutes** (glaze reduction)
...
### Protein
- [ ] **4 Chicken Thighs** (approx 1.75 lbs) — *Can be thawed or frozen - see timing below.*

### Rice/Grains
- [ ] **1.5 cups Basmati Rice** (OR Long Grain White - see timing) — *Rinse until water runs clear (3-4 rinses).*

### Seasonings (Before Pressure)
- [ ] **2 tbsp Honey** — *The sweet component. Any honey works - clover, wildflower, etc.*
...
- [ ] **1 tsp Ginger Powder** — *Adds Asian warmth. Already in Tier 3 if you have it.*
...
### The Glaze (Made from Cooking Liquid)
- [ ] **Cooking liquid from Phase 1** — *We'll reduce this to create the glaze.*

### Late-Stage Drizzle (After Cooking)
- [ ] **Fresh Cracked Black Pepper** — *Adds brightness that pressure cooking kills.*
...
**What You're Doing:** Cooking the chicken in honey + soy sauce liquid. The chicken sits on a trivet so it steams, not boils. The cooking liquid becomes our glaze base.

1. **Add Liquid & Seasonings:** Pour **1.75 cups broth** into the pot. Add **2 tbsp honey**, **2 tbsp soy sauce**, **1 tsp garlic powder**, and **1 tsp salt**. **Optional upgrades:** Add 1 tsp ginger powder and/or 1/2 tsp sesame seeds. **Stir once** to mix - the honey will dissolve as it heats.

   *Why now?* The honey and soy sauce infuse the chicken as it cooks. The liquid becomes our glaze base - it's already flavored!
...
4. **Pressure Cook:** Lock the lid. Set to **High Pressure** for:
   - **8 minutes** (thawed chicken)
   - **14 minutes** (frozen chicken, 12m minimum)
   
   The cooker will take 5-8 minutes to come to pressure.

5. **Natural Release:** Once cooking is done, **wait 10 minutes** (this is the Natural Release - NR). The timer will count down. **Don't touch anything** - let the pressure drop naturally. This is crucial for chicken texture.

6. **Quick Release:** After 10 minutes, turn the valve to **Venting** (Quick Release - QR) to release any remaining pressure. Wait until the float valve drops.

7. **Remove Chicken:** Use tongs to carefully remove the chicken thighs. Place them on a plate or cutting board. **Save the cooking liquid** - this is our glaze base! Don't discard it.

8. **Rest the Chicken:** Let the chicken rest **5 minutes minimum**. This makes it juicy. Cover loosely with foil if you want.

### Phase 2: The Rice (6m HP + 10m NR)
...
3. **Add Beans (Optional):** If using black beans, add them now. Stir gently.

4. **Pressure Cook:** Lock the lid. Set to **High Pressure** for:
   - **6 minutes** (Basmati)
   - **5 minutes** (Long Grain White)
   
   The cooker will take 5-8 minutes to come to pressure.

5. **Natural Release:** Once cooking is done, **wait 10 minutes** (NR). This is mandatory for rice to finish cooking and set properly.

6. **Quick Release:** After 10 minutes, turn the valve to **Venting** (QR) to release any remaining pressure.

7. **Fluff the Rice:** Use a fork to fluff the rice gently (don't mash it - just separate the grains).

### Phase 3: The Glaze (5 minutes)

**What You're Doing:** Reducing the cooking liquid from Phase 1 to create a thick, sticky glaze. This is the "restaurant-quality" finish. **We're using the pressure cooker's sauté function - no extra pans needed!**
...
5. **Test the Glaze:** Dip a spoon into the liquid. If it coats the spoon and doesn't run off immediately, it's ready. It should be **thick and sticky**, like honey or maple syrup.
...
1. **Portion the Rice:** Divide the rice (and beans, if using) into bowls.

2. **Add the Chicken:** Place chicken thighs on top of the rice.

3. **Drizzle the Glaze:** Drizzle the **reduced glaze** over the chicken and rice. Start with 1-2 tbsp per bowl - you can always add more. The glaze should be thick and sticky.

4. **Add Fresh Pepper:** Crack fresh black pepper over the top. This adds brightness that pressure cooking kills.

5. **Serve Immediately:** This is best eaten fresh and hot, while the glaze is still warm and sticky.
...
- **Honey (sweet):** Adds natural sweetness that balances the salty soy sauce
- **Soy Sauce (savory/umami):** Adds depth and saltiness that balances the honey
- **Together:** They create a complex flavor that's more than the sum of its parts - this is the "restaurant-quality" taste

**The Glaze Reduction Technique:**
- **Water evaporates:** As you simmer the liquid, water evaporates, concentrating the flavors
- **Honey thickens:** Honey naturally thickens when heated and reduced
- **Soy sauce concentrates:** The umami flavors in soy sauce become more intense as water evaporates
- **Result:** A thick, sticky glaze that clings to the chicken and rice

**Why Cook Chicken First:**
- **Flavor infusion:** The chicken absorbs the honey + soy sauce flavors as it cooks
- **Cooking liquid becomes glaze base:** The liquid that the chicken cooked in is already flavored - perfect for reducing into a glaze
- **Sequential cooking:** Rice cooks in the same pot, picking up residual flavors
...
- **Glaze base:** The remaining liquid (after rice absorbs what it needs) becomes your glaze
...
**If you have too much glaze:**
- Store it in the fridge (lasts 1-2 weeks)
- Use it on other proteins (chicken, pork, fish)
- Drizzle over rice bowls, stir-fries, etc.

**If you have too little glaze:**
- The reduction process concentrates the liquid - you'll always have less volume than you started with
- This is normal! A little glaze goes a long way
- If you need more, make a quick batch: 1 tbsp honey + 1 tbsp soy sauce + 1/4 cup water, reduce until thick
...
## Version History
- **v1.0:** Initial recipe - Honey Garlic Chicken Bowl with glaze reduction technique
