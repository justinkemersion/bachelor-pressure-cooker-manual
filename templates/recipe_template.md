...
### Protein
- [ ] [Amount] [Protein] ([State: thawed/frozen])

### Rice/Grains
- [ ] [Amount] [Rice type], rinsed

### Seasonings (Before Pressure)
- [ ] [Amount] [Spice/seasoning]
- [ ] [Amount] [Spice/seasoning]

### Liquids
- [ ] [Amount] [Liquid: water/broth]

### Late-Stage Drizzle (After Cooking)
- [ ] [Amount] [Acid: lemon/lime/vinegar]
...
### Phase 2: Sear (Optional but Recommended)
1. Set Instant Pot to **Sauté (High)**
2. Add **1-2 tbsp oil**, wait for "HOT"
3. Sear [protein] **2-3 minutes per side** (don't move until browned)
4. Remove protein, set aside
5. Deglaze with **[amount] [liquid]**, scrape bottom

### Phase 3: Pressure Cook
1. Add [ingredients] to pot
2. Lock lid, set to **High Pressure** for **[XX minutes]**
3. **Natural Release** for **[XX minutes]**, then quick release remaining

### Phase 4: Finish & Serve
1. Remove [protein/rice]
2. **Drizzle with [acid]** (lemon/lime/vinegar)
3. Add fresh [herbs] if available
...
### Why This Works
- [Explanation of flavor profile choices]
- [Why specific spices/acids were chosen]
- [Why this cooking method]

### Substitutions
- **No [ingredient]?** → [Substitution option]
- **Want more heat?** → Add [spice] post-cook
- **Different protein?** → Adjust timing per timing chart
...
**Note:** For abbreviations (HP, NR, QR, etc.), see the **Initiation Recipe** (`chipotle_burrito_bowl.md`) Quick Reference section. Only include abbreviations here if you're introducing **new** abbreviations not covered in the Initiation Recipe.
