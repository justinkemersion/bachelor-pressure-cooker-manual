# Marinade Recipes: The Bachelor's Flavor Arsenal

**Why marinade?** Flavor develops during freezing and thawing. When you're ready to cook, the chicken is already seasoned - no prep needed.

**How to use:** See `02_techniques/bulk_prep_and_freezing.md` for the complete marinade & freeze system.
...
**Chemistry Notes:**
- **Cumin:** Earthy, warm base - signature Tex-Mex flavor
- **Chili powder:** Heat + flavor blend (contains cumin, garlic, oregano)
- **Lime juice:** Bright acid - cuts through richness, adds freshness
- **Oil:** Carries flavors, keeps chicken moist

**Best for:** Burrito bowls, tacos, fajitas, Tex-Mex rice bowls
...
**Best for:** Pasta dishes, Italian rice bowls, Mediterranean bowls
...
**Chemistry Notes:**
- **Soy sauce:** Salty umami - depth and savory complexity
- **Ginger:** Bright, sharp heat - signature Asian flavor
- **Rice vinegar:** Mild acid - balances richness without overpowering

**Best for:** Asian rice bowls, stir-fries, teriyaki dishes
...
**Best for:** Mediterranean bowls, Greek salads, simple rice bowls

---

## Marinade Chemistry: The Basics
...
**For bulk prep (2-3 lbs / 8-10 thighs):**
- Multiply individual portion by 4
- Mix in large bowl, divide into freezer bags

**For single meal (2-3 thighs):**
- Use individual portion recipes above
- Adjust heat (red pepper flakes) to taste

---

## Quick Reference: Which Marinade When?

| Marinade | Best For | Heat Level | Complexity |
| :--- | :--- | :--- | :--- |
| **Pantry Hero** | Everything (most versatile) | Medium | Medium |
| **Tex-Mex** | Burrito bowls, tacos | Medium-Hot | Low |
| **Italian** | Pasta, Mediterranean bowls | Mild | Low |
| **Asian** | Asian rice bowls, stir-fries | Mild-Medium | Low |
| **Mediterranean** | Simple bowls, salads | Mild | Very Low |

---

## Bachelor's Tips

### Spice Packet Shortcut
**Don't have individual spices?** Use spice packets (Taco, Fajita, Italian) + oil + acid. Works great!

### Make Ahead
**Mix marinades in bulk** - store in fridge for 1-2 weeks. Ready when you need them.

### Freezer-Friendly
**All marinades freeze well** - add to chicken in freezer bags, freeze flat. Flavor develops during freezing/thawing.

### Don't Overthink It
**Start with Pantry Hero** - it works with almost everything. Build your collection as you go.

---

## 🔗 Related References

- **Bulk Prep System:** `02_techniques/bulk_prep_and_freezing.md` ← How to use these marinades
- **Flavor Chemistry:** `01_fundamentals/spices_and_flavor.md` ← Understand the "why"
- **Pantry Essentials:** `04_reference/bachelors_essentials.md` ← What to keep on hand

---

**Version:** 1.0 | **Last Updated:** 2024 | **Print Scale:** Full page reference
