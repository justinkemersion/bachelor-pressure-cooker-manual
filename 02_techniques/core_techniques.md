...
### Why Sear?
- Builds "fond" (browned bits) = deep flavor
- Creates texture contrast
- Prevents rubbery chicken
...
- Don't overcook (follow timing charts)
- Rinse thoroughly
...
2. Place trivet/steamer basket
3. Put rice in separate container (oven-safe bowl, silicone container)
4. Place protein in pot (or in separate container)
5. Stack containers if needed
6. Pressure cook (use longer time if needed)
...
- **How:** Wait 10-15 minutes, then manually release remaining pressure

### Quick Release (QR)
- **When:** Vegetables, delicate proteins, when recipe specifies
- **Why:** Stops cooking immediately
- **How:** Turn valve to venting position immediately

### 10m NR (Hybrid)
- Wait 10 minutes natural release
...
### Reheating Tips
- **Rice:** Always add moisture (water) to prevent drying
...
### Rubbery Chicken
- **Cause:** Overcooking, not searing, quick release
- **Fix:** Sear first, use correct timing, natural release

### Mushy Rice
- **Cause:** Too much water, overcooking, not rinsing
- **Fix:** Exact 1:1 ratio, rinse thoroughly, natural release

### Weird Bean Consistency
- **Cause:** Undercooking, not soaking, wrong release
- **Fix:** Soak properly, use correct timing, natural release

### Bland Food
- **Cause:** Not layering seasonings, missing acid/umami
- **Fix:** Season during cooking AND after, add acid drizzle